    ...
    <center>
        <div id="iol">
            ...
            <ul style="text-align:left;">
                ...
                <li>You start with 15 steps. Each level gives +5 more.</li>
...
function start(r, l) {
    min = 0, sec = 0, moves = 0;
    stepsLeft = baseSteps + currentLevel * 5;
...
function change(x) {
    ...
    if (turn == 1) {
        ...
        if (pre != $(b).attr("src")) {
            ...
            // 🧠 Decrease steps only on wrong match
            stepsLeft--;
            $("#steps").html("Steps Left: " + stepsLeft);

            // 💥 Game over if steps run out
...
// Add Pause and Back buttons to the main UI (right/timing section)
$(document).ready(function () {
    // Add pause and back buttons if not already present
